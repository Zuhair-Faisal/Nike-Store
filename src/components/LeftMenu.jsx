...
const LeftMenu = () => {
    ...
    const RoundCheckbox = (props) => {
        ...
        return (
            ...
            >
                <span className={`inline-block w-4 h-4 rounded-full border border-gray-300 ${selectedPriceRange === props.label ? 'bg-black' : 'bg-white'}`}></span>
                <span className={`${selectedPriceRange === props.label ? 'font-bold text-black' : ''}`}>{props.label}</span>
            </label>
        );
    };
    ...
    const CategoriesItem = (props) => {
        ...
        return (
            <li
                className={`flex justify-between cursor-pointer ${selectedCategory === props.category ? 'font-bold text-black' : ''}`}
    ...
    const ColorsItem = (props) => {
        ...
        return (
            <li
                className={`h-6 w-6 rounded-full cursor-pointer ${activeColor === props.color ? 'outline outline-black' : ''}`}
    ...
    const SizeSquare = (props) => {
        ...
        return (
            <td
                ...
                ${selectedSize === props.size ? 'bg-[#ffffff] font-bold text-black' : ''}`}
    ...
    return (
        <div className="flex flex-col gap-y-6">
            <section>
                <h3
                    className="text-black font-bold flex justify-between items-center cursor-default"
            ...
            <section>
                <button
                    className='w-full rounded-lg text-center text-gray-500 hover:text-black border-[3px] border-gray-300 hover:border-black font-bold py-2'
